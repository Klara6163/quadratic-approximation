...
#endif
            VL_FATAL_MT("quadra_top.vs", 3, "", "DIDNOTCONVERGE: Settle region did not converge after '--converge-limit' of 100 tries");
        }
...
VL_ATTR_COLD void Vquadra_top___024root___stl_sequent__TOP__0(Vquadra_top___024root* vlSelf) {
    ...
    vlSelfRef.quadra_top__DOT__a = Vquadra_top__ConstPool__TABLE_hd6a148d3_0
        [__Vtableidx1];
    __Vtableidx2 = (0x0000007fU & (vlSelfRef.x >> 0x00000011U));
    vlSelfRef.quadra_top__DOT__b = Vquadra_top__ConstPool__TABLE_had744450_0
        [__Vtableidx2];
    __Vtableidx3 = (0x0000007fU & (vlSelfRef.x >> 0x00000011U));
    vlSelfRef.quadra_top__DOT__c = Vquadra_top__ConstPool__TABLE_hdbbed8c8_0
        [__Vtableidx3];
}
...
VL_ATTR_COLD void Vquadra_top___024root___ctor_var_reset(Vquadra_top___024root* vlSelf) {
    ...
    vlSelf->quadra_top__DOT__a = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 1400132405883092656ull);
    vlSelf->quadra_top__DOT__b = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 9828453562698441935ull);
    vlSelf->quadra_top__DOT__c = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 8292862798293297936ull);
    vlSelf->quadra_top__DOT__y_p0 = VL_SCOPED_RAND_RESET_I(25, __VscopeHash, 1895327409244634515ull);
    vlSelf->quadra_top__DOT__y_p1 = VL_SCOPED_RAND_RESET_I(25, __VscopeHash, 7646223248891210403ull);
    vlSelf->quadra_top__DOT__y_p2 = VL_SCOPED_RAND_RESET_I(25, __VscopeHash, 14022116346558099317ull);
