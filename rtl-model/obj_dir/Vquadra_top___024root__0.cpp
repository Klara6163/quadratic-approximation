...
void Vquadra_top___024root___nba_sequent__TOP__0(Vquadra_top___024root* vlSelf) {
    ...
    if (vlSelfRef.rst_b) {
        ...
        vlSelfRef.quadra_top__DOT__y_p1 = vlSelfRef.quadra_top__DOT__y_p0;
        vlSelfRef.quadra_top__DOT__y_p0 = (0x01ffffffU 
                                           & (IData)(
...
void Vquadra_top___024root___eval(Vquadra_top___024root* vlSelf) {
    ...
    do {
        if (VL_UNLIKELY(((0x00000064U < __VicoIterCount)))) {
            ...
            Vquadra_top___024root___dump_triggers__ico(vlSelfRef.__VicoTriggered, "ico"s);
#endif
            VL_FATAL_MT("quadra_top.vs", 3, "", "DIDNOTCONVERGE: Input combinational region did not converge after '--converge-limit' of 100 tries");
        }
    ...
    do {
...
#endif
            VL_FATAL_MT("quadra_top.vs", 3, "", "DIDNOTCONVERGE: NBA region did not converge after '--converge-limit' of 100 tries");
        }
        ...
        do {
            if (VL_UNLIKELY(((0x00000064U < vlSelfRef.__VactIterCount)))) {
                ...
                Vquadra_top___024root___dump_triggers__act(vlSelfRef.__VactTriggered, "act"s);
#endif
                VL_FATAL_MT("quadra_top.vs", 3, "", "DIDNOTCONVERGE: Active region did not converge after '--converge-limit' of 100 tries");
            }
